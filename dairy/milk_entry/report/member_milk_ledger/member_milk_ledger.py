...
def get_columns(filters):
	columns = [
			...
			{"label": _("DCS"), "fieldname": "dcs_id", "fieldtype": "Data", "width": 150,'precision': 2},
			{"label": _("Ltr"), "fieldname": "volume", "fieldtype": "Float", "width": 150,'precision': 2},
			{"label": _("Weight(in kg)"), "fieldname": "litre", "fieldtype": "Float", "width": 150,'precision': 2},
			{"label": _("Fat%"), "fieldname": "fat", "fieldtype": "Percent", "width": 150,'precision': 2},
			{"label": _("Fat(in kg)"), "fieldname": "fat_kg", "fieldtype": "Float", "width": 150,'precision': 2},
			{"label": _("SNF%"), "fieldname": "snf", "fieldtype": "Percent", "width": 150,'precision': 2},
			{"label": _("SNF(in kg)"), "fieldname": "snf_kg", "fieldtype": "Float", "width": 150,'precision': 2},
			{"label": _("CLR%"), "fieldname": "clr", "fieldtype": "Percent", "width": 150,'precision': 2},
			{"label": _("CLR(in kg)"), "fieldname": "clr_kg", "fieldtype": "Float", "width": 150,'precision': 2},
			{"label": _("Rate"), "fieldname": "unit_price", "fieldtype": "Currency", "width": 150,'precision': 2},
			{"label": _("Amount"), "fieldname": "total", "fieldtype": "Currency", "width": 150,'precision': 2},
			{"label": _("SNF Deduction"), "fieldname": "snf_deduction", "fieldtype": "Currency", "width": 150,'precision': 2},
			{"label": _("FAT Deduction"), "fieldname": "fat_deduction", "fieldtype": "Currency", "width": 150,'precision': 2},
			{"label": _("Incentive"), "fieldname": "incentive", "fieldtype": "Currency", "width": 150,'precision': 2},
